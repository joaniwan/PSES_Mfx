/**===================================================================================================================*\
  ...
  @brief Bibiloteka Mfx - implementacja
...
/**
 ...
 This routine makes an addition between the two arguments.
  Project element: [SWS_Mfx_00002] & [SWS_Mfx_00006] & [SWS_Mfx_00007] & [SWS_Mfx_00008 Function ID: 0x00C & 0x014]
*/
...
/**
  ...
  Project element: [SWS_Mfx_00017] & [SWS_Mfx_00018] & [SWS_Mfx_00019] & [SWS_Mfx_00020 Function ID:  0x066 & 0x069 & 0x078]
*/
...
{  
    sint64 tmp = (uint64)x_value - (uint64)y_value ;
...
/**
  ...
  Project element: [SWS_Mfx_00021] & [SWS_Mfx_00022] & [SWS_Mfx_00023] & [SWS_Mfx_00024 Function ID: 0x08A & 0x94]
*/
...
/**
  ...
  These routines make a multiplication between the two arguments and a division by the third argument.
...
*/
sint16 Mfx_MulDiv_s16s16_s16(sint16 x_value, sint16 y_value, sint16 z_value)
{
	sint16 tmp = Mfx_Mul_s16s16_s16(x_value,y_value);
    return Mfx_Div_s16s16_s16(tmp,z_value);
}

sint32 Mfx_MulDiv_s32s32_s32(sint32 x_value, sint32 y_value, sint32 z_value)
{
...
*/
sint16 Mfx_RMulDiv_s16s16_s16(sint16 x_value, sint16 y_value, sint16 z_value)
{
	sint16 tmp = Mfx_Mul_s16s16_s16(x_value,y_value);
    return Mfx_RDiv_s16s16_s16(tmp,z_value);
}

sint32 Mfx_RMulDiv_s32s32_s32(sint32 x_value, sint32 y_value, sint32 z_value)
{
	sint32 tmp= Mfx_Mul_s32s32_s32(x_value,y_value);
 ...
 /**
  ...
  This routine makes a multiplication between the two arguments and applies a shift right defined by the third argument.
  Project element: [SWS_Mfx_00053] & [SWS_Mfx_00054] & [SWS_Mfx_00055] & [SWS_Mfx_00056] & [SWS_Mfx_00057 Function ID: 0x13E & 0x14B]
*/
sint16 Mfx_MulShRight_s16s16u8_s32(sint16 x_value, sint16 y_value, uint8 shift)
{
...
/**
  ...
  TThis routine returns the minimum between two values.
  Project element: [SWS_Mfx_00082] & [SWS_Mfx_00090] & [SWS_Mfx_00091] & [SWS_Mfx_00092] & [SWS_Mfx_00093] & [SWS_Mfx_00094] & [SWS_Mfx_00095] &  [SWS_Mfx_00096 Function ID: 0x188  & 0x18A & 0x18E & 0x190]
*/
...
/**
  @brief 16-Bit to 8-Bit 2n Scaled Integer Conversion
...
/**
  @brief 8-Bit to 16-Bit 2n Scaled Integer Conversion
...
/**
  @brief 32-Bit to 16-Bit 2n Scaled Integer Conversion
...
/**
  @brief 16-Bit to 32-Bit 2n Scaled Integer Conversion
...
/**
  @brief 16-Bit Multiplication of 2n Scaled Integer
...
/**
  @brief 32-Bit Multiplication of 2n Scaled Integer
...
/**
  @brief 16-Bit Division of 2n Scaled Integer
...
/**
  @brief 32-Bit Division of 2n Scaled Integer
...
/**
  @brief 16-Bit Addition of 2n Scaled Integer
...
/**
  @brief 32-Bit Addition of 2n Scaled Integer
...
/**
  @brief 16-Bit Subtraction of 2n Scaled Integer
...
/**
  @brief 32-Bit Subtraction of 2n Scaled Integer
...
sint16 Mfx_AbsDiffP2_s16s16_s16(sint16 x, sint16 y, sint16 a, sint16 b, sint16 c)
{
    ...
    else
    {
        ...
        {
            tmp =Mfx_AbsDiff_s32s32_s32((1 << (b-a)) * x, y);
            if(c>=b)
            {
               tmp = (tmp << (c-b));
            }
...
uint16 Mfx_AbsDiffP2_u16u16_u16(uint16 x, uint16 y, sint16 a, sint16 b, sint16 c)
{
    ...
    else
    {
        ...
        {
            tmp =Mfx_AbsDiff_u32u32_u32((1 << (b-a)) * x, y);
            if(c>=b)
            {
                tmp = (tmp << (c-b));
            }
...
/**
  @brief  16-Bit Absolute Value of 2n Scaled Integer
The routine takes the absolute value of a 16-bit integer with scaling factors set by input
parameters.
...
/**
  @brief  32-Bit Absolute Value of 2n Scaled Integer
The routine takes the absolute value of a 16-bit integer with scaling factors set by input
parameters.
